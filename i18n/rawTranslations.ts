...
const EXACT_AR_TO_EN: Record<string, string> = {
  ...
  "مدير المحافظة - إدارة المدارس والمستخدمين": "Governorate Manager - Manage Schools & Users",
  ...
  "السفر و السياحة و إدارة الأعمال و تقنية المعلومات": "Travel, Tourism, Business Management and IT",
