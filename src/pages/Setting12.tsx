    ...
    <div style={wrapperStyle}>
      <div className="distStats3D" id="dist-stats-report">
        ...
        <div style={{ display: "flex", gap: 12, flexWrap: "wrap", marginBottom: 14 }}>
          ...
          <div className="distTd" style={{ minWidth: 170, color: "#38bdf8" }}>
            {tr("إجمالي مراقب الدور", "Total Duty Invigilator")}: <b>{totals.duty}</b>
          </div>
          ...
          <table className="distTable">
            <thead>
              <tr>
                ...
                <th className="distTh" style={{ color: "#38bdf8" }}>{tr("عدد مراقب دور", "Duty Invigilator Count")}</th>
              ...
              {reportRows.map((r: any, index: number) => {
                ...
                return (
                  <tr key={`${r.dateISO}-${r.period}-${r.subject}-${index}`} className={isBig ? "row-big-deficit" : isDeficit ? "row-deficit" : ""}>
                    ...
                    <td className="distTd" style={{ color: "#38bdf8", fontWeight: 950 }}>{r.dutyAssigned}</td>
            ...
            <tfoot>
              <tr>
                ...
                <td className="distTh" style={{ color: "#38bdf8" }}>{totals.duty}</td>
