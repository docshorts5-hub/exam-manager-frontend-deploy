...
const FIREBASE_PROJECT_ID = "yousuf-cce23";
...
function isEmailBoundAccessPage(page: string): boolean {
  return page === "GovernorateSuperSystem" || page === "MinistrySuperSystem" || page === "SuperAdminArea";
}
...
async function assertPrivilegedAdminEmailBinding(
  ...
  if (!isEmailBoundAccessPage(page)) return null;
